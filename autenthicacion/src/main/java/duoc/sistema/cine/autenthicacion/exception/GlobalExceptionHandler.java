package duoc.sistema.cine.autenthicacion.exception;

import duoc.sistema.cine.autenthicacion.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> erroresMicroServicio(ResourceNotFoundException ex, HttpServletRequest request){
