package duoc.sistema.cine.comentario_service.exception;

import duoc.sistema.cine.comentario_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ComentarioNoEncontrado.class)
    public ResponseEntity<ErrorResponse> funcionNoEncontrada(ComentarioNoEncontrado ex, HttpServletRequest request){
        log.warn("Error comentario no encontrado en la ruta {}", request.getRequestURI());
        ErrorResponse respuesta = new ErrorResponse();
        respuesta.setFecha(LocalDateTime.now());
