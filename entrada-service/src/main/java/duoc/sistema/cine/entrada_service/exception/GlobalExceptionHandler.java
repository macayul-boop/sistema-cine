package duoc.sistema.cine.entrada_service.exception;

import duoc.sistema.cine.entrada_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> funcionNoEncontrada(EntradaNoEncontradaException ex, HttpServletRequest request){
        log.warn("Error entrada no econtrada {}", request.getRequestURI());
        ErrorResponse respuesta = new ErrorResponse();
        respuesta.setFecha(LocalDateTime.now());
    ...
    //Error validacion; funcion o usuario no encontrado en la ruta
    ...
    public ResponseEntity<ErrorResponse> recursoNoEncontrado(RecursoNoEncontradoException ex, HttpServletRequest request){
        log.warn("Error validacion; funcion o usuario no econtrado {}", request.getRequestURI());
        ErrorResponse respuesta = new ErrorResponse();
        respuesta.setFecha(LocalDateTime.now());
        respuesta.setEstado(HttpStatus.NOT_FOUND.value());
        respuesta.setError("Not Found");
