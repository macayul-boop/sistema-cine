package duoc.sistema.cine.objetos_perdidos_service.exception;

import duoc.sistema.cine.objetos_perdidos_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // ObjetoPerdido no encontrado
    @ExceptionHandler(ObjetoPerdidoNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> funcionNoEncontrada(ObjetoPerdidoNoEncontradoException ex, HttpServletRequest request){
        log.warn("Error objetoPerdido no encontrado en la ruta {}", request.getRequestURI());
        ErrorResponse respuesta = new ErrorResponse();
        respuesta.setFecha(LocalDateTime.now());
