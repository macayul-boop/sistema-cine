package duoc.sistema.cine.pelicula.exception;

import duoc.sistema.cine.pelicula.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PeliculaNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarPeliculaNoEncontrado(PeliculaNoEncontradoException ex,
                                                                     HttpServletRequest request) {
        log.warn("Pelicula no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
